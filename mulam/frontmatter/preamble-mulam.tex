...
\hspace{2em}\ifx\shrotaName\empty \else \faUserFriends\ श्रोता --- \shrotaName\fi
  ...
  \ifx\textURL\empty \else\item[\faLink] \href{\textURL}{Source Text} \fi
  \ifx\transURL\empty \else\item[\faGlobe\ Translation:] \url{\transURL} \fi
\end{description}
